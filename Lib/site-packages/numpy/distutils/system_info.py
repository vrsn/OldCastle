...
if sys.platform == 'win32':
    ...
    if conda:
        ...
        add_system_root(os.path.join(conda_dir, '..', 'Lib'))
        add_system_root(os.path.join(conda_dir, 'Lib'))
...
def is_symlink_to_accelerate(filename):
    accelpath = '/System/Lib/Frameworks/Accelerate.framework'
    ...
    def calc_libraries_info(self):
        ...
        for lib in libs:
            ...
            if i is not None:
                ...
                log.info('Lib %s was not found. Ignoring' % (lib))
        ...
        if (sys.platform == 'darwin' and
            ...
            if get_platform()[-4:] == 'i386' or 'intel' in get_platform() or \
               ...
               'i386' in platform.platform():
                ...
                intel = 0
            if (os.path.exists('/System/Lib/Frameworks'
                ...
                args.extend([
                    '-I/System/Lib/Frameworks/vecLib.framework/Headers'])
                link_args.extend(['-Wl,-framework', '-Wl,Accelerate'])
            elif (os.path.exists('/System/Lib/Frameworks'
