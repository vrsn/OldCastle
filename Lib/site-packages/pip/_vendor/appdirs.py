...
def user_data_dir(appname=None, appauthor=None, version=None, roaming=False):
    ...
    Typical user data directories are:
        Mac OS X:               ~/Lib/Application Support/<AppName>  # or ~/.config/<AppName>, if the other does not exist
    ...
    if system == "win32":
        ...
        path = os.path.expanduser('~/Lib/Application Support/')
        if appname:
            path = os.path.join(path, appname)
    else:
...
def site_data_dir(appname=None, appauthor=None, version=None, multipath=False):
    ...
    Typical site data directories are:
        Mac OS X:   /Lib/Application Support/<AppName>
...
def user_cache_dir(appname=None, appauthor=None, version=None, opinion=True):
    ...
    if system == "win32":
        ...
        path = os.path.expanduser('~/Lib/Caches')
        if appname:
            path = os.path.join(path, appname)
    else:
